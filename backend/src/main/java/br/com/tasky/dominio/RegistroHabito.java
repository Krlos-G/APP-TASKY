...
import br.com.tasky.dominio.enums.StatusRegistroHabito;
...
/** Marcacao de um habito num dia. Unico por (habito, data). */
@Entity
...
public class RegistroHabito {
    ...
    /** Data no fuso do usuario, nao do servidor. */
    @Column(nullable = false)
    private LocalDate data;

    @Enumerated(EnumType.STRING)
    @Column(nullable = false, length = 10)
    private StatusRegistroHabito status;
